<template>
    <div>
        ...
        <div style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 24px;">
            ...
            <!-- ===== VERSION 1 iOS Style (优化版) ===== -->
            <div style="display: flex; flex-direction: column; gap: 12px;">
                <!-- 主卡片：iOS 风格小组件 -->
                <div class="apple-card" style="padding: 24px 20px; text-align: center; border: none; position: relative; overflow: hidden;">
                    <!-- iOS 风格：微弱渐变背景 + 发光效果 -->
                    <div style="position: absolute; inset: 0; background: linear-gradient(135deg, rgba(0,122,255,0.06) 0%, rgba(10,102,194,0.03) 100%); pointer-events: none;"></div>
                    
                    <div style="position: relative; z-index: 2;">
                        <div style="display: flex; align-items: center; justify-content: center; color: var(--text-sub); font-size: 13px; font-weight: 600; margin-bottom: 8px; letter-spacing: 0.5px; text-transform: uppercase;">
                            <ion-icon name="flash" style="color: #FFD60A; font-size: 14px; margin-right: 6px;"></ion-icon>今日核心产出
                        </div>
                        <div style="font-size: 3.5rem; font-weight: 900; color: var(--primary); font-family: ui-rounded, -apple-system, sans-serif; line-height: 1.1; text-shadow: 0 2px 12px rgba(0,122,255,0.25);">
                ...
                <div style="display: flex; gap: 10px;">
                    <!-- 实物掉落 -->
                    <div class="apple-card" style="flex: 1; padding: 16px 12px; text-align: center; border: none; position: relative; overflow: hidden;">
                        <div style="position: absolute; inset: 0; background: linear-gradient(135deg, rgba(255,59,48,0.05) 0%, transparent 100%); pointer-events: none;"></div>
                        <ion-icon name="gift-outline" style="font-size: 22px; color: var(--danger); margin-bottom: 6px;"></ion-icon>
                        <div style="font-size: 1.4rem; font-weight: 800; color: var(--text-main); font-family: ui-rounded, sans-serif;">{{ lpStats.total_physical_wins || 0 }}</div>
                        <div style="font-size: 11px; color: var(--text-sub); margin-top: 2px;">实物掉落</div>
                    </div>
                    <!-- 等待执行 -->
                    <div class="apple-card" style="flex: 1; padding: 16px 12px; text-align: center; border: none; position: relative; overflow: hidden;">
                        <div style="position: absolute; inset: 0; background: linear-gradient(135deg, rgba(255,149,0,0.05) 0%, transparent 100%); pointer-events: none;"></div>
                        <ion-icon name="time-outline" style="font-size: 22px; color: var(--ios-orange); margin-bottom: 6px;"></ion-icon>
                        <div style="font-size: 1.4rem; font-weight: 800; color: var(--ios-orange); font-family: ui-rounded, sans-serif;">{{ mpWarningCount || 0 }}</div>
                        <div style="font-size: 11px; color: var(--text-sub); margin-top: 2px;">等待执行</div>
                    </div>
                    <!-- 累计记录 -->
                    <div class="apple-card" style="flex: 1; padding: 16px 12px; text-align: center; border: none; position: relative; overflow: hidden;">
                        <div style="position: absolute; inset: 0; background: linear-gradient(135deg, rgba(0,122,255,0.05) 0%, transparent 100%); pointer-events: none;"></div>
                        <ion-icon name="layers-outline" style="font-size: 22px; color: var(--primary); margin-bottom: 6px;"></ion-icon>
                        <div style="font-size: 1.4rem; font-weight: 800; color: var(--text-main); font-family: ui-rounded, sans-serif;">{{ mpTotalQuantity || 0 }}</div>
                        <div style="font-size: 11px; color: var(--text-sub); margin-top: 2px;">累计记录</div>
                    </div>
                </div>
            </div>
        </div>
