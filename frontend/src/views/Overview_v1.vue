    ...
    <div>
        ...
        <div style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 24px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 12px;">
                <!-- 主卡片：今日核心产出 -->
                <div class="apple-card" style="background: linear-gradient(135deg, var(--primary) 0%, #0A66C2 100%); padding: 24px 20px; text-align: center; border: none;">
                    <div style="display: flex; align-items: center; justify-content: center; color: rgba(255,255,255,0.8); font-size: 14px; font-weight: 600; margin-bottom: 8px;">
                        <ion-icon name="flash" style="color: #FFD60A; font-size: 18px; margin-right: 6px;"></ion-icon>今日核心产出
                    </div>
                    <div style="font-size: 3.5rem; font-weight: 900; color: #FFF; font-family: ui-rounded, -apple-system, sans-serif; line-height: 1.1;">
                ...
                <div style="display: flex; gap: 10px;">
                    <!-- 实物掉落 -->
                    <div class="apple-card" style="flex: 1; padding: 16px 12px; text-align: center; border: none;">
                        <ion-icon name="gift-outline" style="font-size: 24px; color: var(--danger); margin-bottom: 6px;"></ion-icon>
                        <div style="font-size: 1.5rem; font-weight: 800; color: var(--text-main); font-family: ui-rounded, sans-serif;">{{ lpStats.total_physical_wins || 0 }}</div>
                        <div style="font-size: 11px; color: var(--text-sub); margin-top: 2px;">实物掉落</div>
                    </div>
                    <!-- 等待执行 -->
                    <div class="apple-card" style="flex: 1; padding: 16px 12px; text-align: center; border: none;">
                        <ion-icon name="time-outline" style="font-size: 24px; color: var(--ios-orange); margin-bottom: 6px;"></ion-icon>
                        <div style="font-size: 1.5rem; font-weight: 800; color: var(--ios-orange); font-family: ui-rounded, sans-serif;">{{ mpWarningCount || 0 }}</div>
                        <div style="font-size: 11px; color: var(--text-sub); margin-top: 2px;">等待执行</div>
                    </div>
                    <!-- 累计记录 -->
                    <div class="apple-card" style="flex: 1; padding: 16px 12px; text-align: center; border: none;">
                        <ion-icon name="layers-outline" style="font-size: 24px; color: var(--primary); margin-bottom: 6px;"></ion-icon>
                        <div style="font-size: 1.5rem; font-weight: 800; color: var(--text-main); font-family: ui-rounded, sans-serif;">{{ mpTotalQuantity || 0 }}</div>
