<template>
    <div>
        ...
        <div style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 24px;">
            ...
            <div class="bento-main" style="display: flex; flex-direction: column; justify-content: center; align-items: center; min-height: 20px; padding: 22px 14px 14px 14px; position: relative; overflow: hidden; border-radius: 28px; background: linear-gradient(135deg, #1C1C1E 0%, #2C2C2E 100%); text-align: center; border: none;">
                <div style="position: relative; z-index: 2; display: flex; flex-direction: column; align-items: center; margin-top: 30px; margin-bottom: 30px;">
                    <div class="bento-title" style="display: flex; align-items: center; font-size: 14px; opacity: 0.7; font-family: ui-rounded, -apple-system, system-ui, sans-serif; font-weight: 600; color: #FFF;">
                        今日核心产出
                        <ion-icon name="flash" style="color: #FFD60A; font-size: 16px; margin-left: 4px;"></ion-icon>
                    </div>
                    <div class="bento-value" style="display: flex; align-items: baseline; margin-top: -2px;">
                        <span style="font-size: 4.8rem; font-weight: 800; font-family: ui-rounded, -apple-system, system-ui, sans-serif; letter-spacing: -2px; color: #FFF;">{{ lpStats.total_wins || 0 }}</span>
                    </div>
                </div>

                <div style="background: rgba(255, 255, 255, 0.07); border-radius: 20px; padding: 18px 8px; width: 100%; box-sizing: border-box; position: relative; z-index: 2; backdrop-filter: blur(25px); -webkit-backdrop-filter: blur(25px); border: none;">
                    <div class="hero-sub-grid" style="display: flex; justify-content: space-around; align-items: center;">
                        <div class="hero-sub-item" style="text-align: center; flex: 1;">
                            <div class="hero-sub-val" style="color: #FFF; font-size: 20px; font-weight: bold; font-family: ui-rounded, -apple-system, system-ui, sans-serif;">{{ lpStats.total_physical_wins || 0 }}</div>
                            <div class="hero-sub-label" style="color: rgba(255, 255, 255, 0.5); font-size: 12px; margin-top: 2px; font-family: ui-rounded, -apple-system, system-ui, sans-serif; font-weight: 500;">实物掉落</div>
                        </div>
                        <div style="width: 1px; height: 24px; background: rgba(255, 255, 255, 0.1);"></div>
                        <div class="hero-sub-item" style="text-align: center; flex: 1;">
                            <div class="hero-sub-val" style="color: var(--ios-orange); font-size: 20px; font-weight: bold; font-family: ui-rounded, -apple-system, system-ui, sans-serif;">{{ mpWarningCount || 0 }}</div>
                            <div class="hero-sub-label" style="color: rgba(255, 255, 255, 0.5); font-size: 12px; margin-top: 2px; font-family: ui-rounded, -apple-system, system-ui, sans-serif; font-weight: 500;">等待执行</div>
                        </div>
                        <div style="width: 1px; height: 24px; background: rgba(255, 255, 255, 0.1);"></div>
                        <div class="hero-sub-item" style="text-align: center; flex: 1;">
                            <div class="hero-sub-val" style="color: #FFF; font-size: 20px; font-weight: bold; font-family: ui-rounded, -apple-system, system-ui, sans-serif;">{{ mpTotalQuantity || 0 }}</div>
                            <div class="hero-sub-label" style="color: rgba(255, 255, 255, 0.5); font-size: 12px; margin-top: 2px; font-family: ui-rounded, -apple-system, system-ui, sans-serif; font-weight: 500;">累计记录</div>
                        </div>
                    </div>
                </div>
                <ion-icon name="diamond" style="position: absolute; right: -35px; bottom: -25px; font-size: 240px; color: rgba(255, 255, 255, 0.025); transform: rotate(-12deg); pointer-events: none; z-index: 1;"></ion-icon>
            </div>
        </div>
