<template>
    <div>
        ...
        <div style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 24px;">
            ...
            <!-- ===== VERSION iOS 参考设计 ===== -->
            <!-- 黑色背景 + 无投影 + 简洁圆角 -->
            <div class="apple-card" style="padding: 0; border: none; box-shadow: none; background: transparent;">
                <!-- 主卡片：iOS 风格深色背景，无投影 -->
                <div style="background: linear-gradient(135deg, #1C1C1E 0%, #2C2C2E 100%); border-radius: 20px; padding: 28px 20px; text-align: center; position: relative; overflow: hidden;">
                    <!-- 装饰图标 -->
                    <div style="position: absolute; right: -15px; top: -20px; font-size: 100px; opacity: 0.06; color: #fff; transform: rotate(15deg); pointer-events: none;">
                        <ion-icon name="flash"></ion-icon>
                    </div>
                    
                    <div style="position: relative; z-index: 2;">
                        <div style="display: flex; align-items: center; justify-content: center; color: rgba(255,255,255,0.6); font-size: 13px; font-weight: 600; margin-bottom: 8px; letter-spacing: 0.5px; text-transform: uppercase;">
                            <ion-icon name="flash" style="color: #FFD60A; font-size: 14px; margin-right: 6px;"></ion-icon>今日核心产出
                        </div>
                        <div style="font-size: 3.8rem; font-weight: 900; color: #FFF; font-family: ui-rounded, -apple-system, sans-serif; line-height: 1; letter-spacing: -2px;">
                ...
                <div style="display: flex; gap: 10px; margin-top: 10px;">
                    <!-- 实物掉落 -->
                    <div style="flex: 1; background: var(--card-bg); border-radius: 14px; padding: 14px 10px; text-align: center; box-shadow: none;">
                        <ion-icon name="gift-outline" style="font-size: 20px; color: var(--danger); margin-bottom: 4px;"></ion-icon>
                        <div style="font-size: 1.3rem; font-weight: 800; color: var(--text-main); font-family: ui-rounded, sans-serif;">{{ lpStats.total_physical_wins || 0 }}</div>
                        <div style="font-size: 10px; color: var(--text-sub); margin-top: 2px;">实物掉落</div>
                    </div>
                    <!-- 等待执行 -->
                    <div style="flex: 1; background: var(--card-bg); border-radius: 14px; padding: 14px 10px; text-align: center; box-shadow: none;">
                        <ion-icon name="time-outline" style="font-size: 20px; color: var(--ios-orange); margin-bottom: 4px;"></ion-icon>
                        <div style="font-size: 1.3rem; font-weight: 800; color: var(--ios-orange); font-family: ui-rounded, sans-serif;">{{ mpWarningCount || 0 }}</div>
                        <div style="font-size: 10px; color: var(--text-sub); margin-top: 2px;">等待执行</div>
                    </div>
                    <!-- 累计记录 -->
                    <div style="flex: 1; background: var(--card-bg); border-radius: 14px; padding: 14px 10px; text-align: center; box-shadow: none;">
                        <ion-icon name="layers-outline" style="font-size: 20px; color: var(--primary); margin-bottom: 4px;"></ion-icon>
                        <div style="font-size: 1.3rem; font-weight: 800; color: var(--text-main); font-family: ui-rounded, sans-serif;">{{ mpTotalQuantity || 0 }}</div>
                        <div style="font-size: 10px; color: var(--text-sub); margin-top: 2px;">累计记录</div>
                    </div>
                </div>
            </div>
        </div>
