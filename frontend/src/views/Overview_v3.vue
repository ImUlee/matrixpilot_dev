<template>
    <div>
        ...
        <div style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 24px;">
            ...
            <!-- ===== VERSION 3: 紧凑数字墙式 ===== -->
            <div class="apple-card" style="padding: 20px 16px; border: none;">
                <!-- 主数据行 -->
                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 16px; padding-bottom: 16px; border-bottom: 1px solid var(--border-color);">
                    <div style="display: flex; align-items: center;">
                        <ion-icon name="flash" style="color: #FFD60A; font-size: 20px; margin-right: 8px;"></ion-icon>
                        <span style="font-size: 14px; font-weight: 600; color: var(--text-main);">今日核心产出</span>
                    </div>
                    <div style="font-size: 2.5rem; font-weight: 900; color: var(--primary); font-family: ui-rounded, -apple-system, sans-serif; line-height: 1;">
                ...
                <div style="display: flex; gap: 12px;">
                    <!-- 实物掉落 -->
                    <div style="flex: 1; display: flex; align-items: center; gap: 10px; padding: 12px; background: linear-gradient(135deg, rgba(255,59,48,0.08) 0%, rgba(255,59,48,0.02) 100%); border-radius: 14px;">
                        <div style="width: 36px; height: 36px; border-radius: 10px; background: rgba(255,59,48,0.15); display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                            <ion-icon name="gift-outline" style="font-size: 18px; color: var(--danger);"></ion-icon>
                        </div>
                        <div style="flex: 1; min-width: 0;">
                            <div style="font-size: 1.25rem; font-weight: 800; color: var(--danger); font-family: ui-rounded, sans-serif; line-height: 1.2;">{{ lpStats.total_physical_wins || 0 }}</div>
                            <div style="font-size: 10px; color: var(--text-sub); font-weight: 500;">实物掉落</div>
                        </div>
                    </div>
                    <!-- 等待执行 -->
                    <div style="flex: 1; display: flex; align-items: center; gap: 10px; padding: 12px; background: linear-gradient(135deg, rgba(255,149,0,0.08) 0%, rgba(255,149,0,0.02) 100%); border-radius: 14px;">
                        <div style="width: 36px; height: 36px; border-radius: 10px; background: rgba(255,149,0,0.15); display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                            <ion-icon name="time-outline" style="font-size: 18px; color: var(--ios-orange);"></ion-icon>
                        </div>
                        <div style="flex: 1; min-width: 0;">
                            <div style="font-size: 1.25rem; font-weight: 800; color: var(--ios-orange); font-family: ui-rounded, sans-serif; line-height: 1.2;">{{ mpWarningCount || 0 }}</div>
                            <div style="font-size: 10px; color: var(--text-sub); font-weight: 500;">等待执行</div>
                        </div>
                    </div>
                    <!-- 累计记录 -->
                    <div style="flex: 1; display: flex; align-items: center; gap: 10px; padding: 12px; background: linear-gradient(135deg, rgba(0,122,255,0.08) 0%, rgba(0,122,255,0.02) 100%); border-radius: 14px;">
                        <div style="width: 36px; height: 36px; border-radius: 10px; background: rgba(0,122,255,0.15); display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                            <ion-icon name="layers-outline" style="font-size: 18px; color: var(--primary);"></ion-icon>
                        </div>
                        <div style="flex: 1; min-width: 0;">
                            <div style="font-size: 1.25rem; font-weight: 800; color: var(--primary); font-family: ui-rounded, sans-serif; line-height: 1.2;">{{ mpTotalQuantity || 0 }}</div>
                            <div style="font-size: 10px; color: var(--text-sub); font-weight: 500;">累计记录</div>
                        </div>
                    </div>
                </div>
            </div>
